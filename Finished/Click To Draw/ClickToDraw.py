...
ui_turtle.ht()
ui_turtle.penup()
ui_turtle.goto(screenMinX, screenMaxY - 22)
ui_turtle.write("TurtleDraw!     Pick a color n go to town xD                            Tip: Use white to move the cursor across the screen!\nBy Cutiey :)", align="left", font=("Courier", 8, "bold"))
